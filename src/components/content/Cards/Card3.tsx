...
export const Card3 = ({
  ...
  const renderStatusIcon = (item: AppContent) => {
    if (item.ssiDetailData[0].participationStatus.toLowerCase() === StatusVariants.active) {
      return <CheckCircleOutlineIcon className="statusIcon activeIcon" />
    } else if (item.ssiDetailData[0].participationStatus.toLowerCase() === StatusVariants.pending) {
          ...
          <div className="itemList" key={item.credentialType}>
            ...
            >
              ...
              >
                ...
                {
                  item.ssiDetailData[0].participationStatus.toLowerCase() !== StatusVariants.active && item.ssiDetailData[0].participationStatus.toLowerCase() !== StatusVariants.pending &&
                  <DeleteOutlineIcon
              ...
              <Typography
                ...
                className="status"
              >
                {'Status: '}{item.ssiDetailData[0].participationStatus}
              </Typography>
              {
                item.ssiDetailData[0].participationStatus.toLowerCase() === StatusVariants.pending &&
                <>
                  <Box
